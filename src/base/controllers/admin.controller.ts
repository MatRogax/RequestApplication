...
export class AdminController {
    ...
    @ApiResponse({ status: 201, description: 'Administrador cadastrado com sucesso', type: AdminDto })
    ...
    @ApiResponse({ status: 200, description: 'Administrador encontrado com sucesso', type: AdminDto })
    ...
    @ApiResponse({ status: 200, description: 'Lista de administradores', type: [AdminDto] })
    async getallAdmins() {
    ...
    @ApiParam({ name: 'id', required: true, description: 'ID do administrador a ser atualizado' })
    @ApiResponse({ status: 200, description: 'Administrador atualizado com sucesso', type: AdminDto })
    @ApiResponse({ status: 404, description: 'Administrador não encontrado' })
    ...
    @ApiParam({ name: 'id', required: true, description: 'ID do administrador a ser deletado' })
    @ApiResponse({ status: 200, description: 'Administrador deletado com sucesso' })
    @ApiResponse({ status: 404, description: 'Administrador não encontrado' })
